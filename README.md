...
<!-- BLOGPOSTS:START -->
 ...
 - [Tutorial: Chat Application &lpar;Client-Server&rpar; in Rust](https://eleftheriabatsou.hashnode.dev/tutorial-chat-application-client-server-in-rust)<!-- BLOGPOSTS:END -->
---
